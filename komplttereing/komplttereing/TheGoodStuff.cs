...
namespace komplttereing
{
    static class TheGoodStuff
    {
        ...
        public static int Integer(string question) //returns an int that the player inputs
        {
        ...
        public delegate T StoreReturnMethods<T>();

        public static T Selection<T>(string[] items, string question, int columns, StoreReturnMethods<T>[] methods) //selection that returns method of given type
        {
            int index = Selection(items, question, columns); //call selection
            T result = methods[index]();
            return result;
        }
        ...
        public class RandomCollection<T>
        {
            ...
            {
                array = preArray;
                Random(); //uses it muliple times to make it randomer
                Random();
                Random();
            }
